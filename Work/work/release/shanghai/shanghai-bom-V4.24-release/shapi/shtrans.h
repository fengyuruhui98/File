...
#define CNTCARD		   0x54			//上海计次卡
#define COMMCARD	   0x53			//上海普通卡
...
#define CE_BOM_TRAIN_NOT_USE		0x05    //20220222 BOM
#define CE_BOM_CHUXING_NOT_USE	0x06
#define CE_BOM_QR_TIME_ERR			0x07
#define CE_BOM_QR_VER_ERR		0x08
#define CE_BOM_SM2ERR						0x09
#define CE_BOM_CERT         0x21
#define CE_BOM_MAP          0x20
//#define CE_BOM_CERT_MAP     0xa0

#define CE_AUTHENERROR   		0x10
...
#define CE_NEED_M1_RESTORE   	0x84  //M1上次交易未正常完成，需要恢复
#define CE_KEY_CALERROR       	0xd0 //密钥计算错误
...
UBYTE hh_trans_addvalue(void);
UBYTE hh_trans_expiredata(UBYTE *rec_buf);
UBYTE hh_trans_returndata(void);
