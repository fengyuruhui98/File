...
#define CE_AUTHENERROR   0x10		//认证失败（用于双向认证的MAC校验错误）
#define CE_READERROR     0x11
#define CE_WRITEERROR    0x12		//写卡故障（更新应用区应答错误）
#define CE_CARDREMOVED   0x13		//操作过程中卡移动（用于更新应用区接收蓝牙超时）
...
#define	CE_BLUENOADDRESS	0x50		//未搜到指定地址的蓝牙广播
#define CE_BLUEUNONLIE		0x51		//链接指定蓝牙地址失败
#define CE_BLUEOVERTIME		0x52		//接收蓝牙应答数据超时
