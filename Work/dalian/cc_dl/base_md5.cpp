...
void CMd5::md5_init_ctx (struct md5_ctx *ctx)
{
    ctx->A = 0x67452301;
    ctx->B = 0xefcdab89;
    ctx->C = 0x98badcfe;
...
void CMd5::md5_process_block  (const void *buffer, size_t len,  struct md5_ctx *ctx)
{
...
void CMd5::md5_process_bytes  (const void *buffer, size_t len,  struct md5_ctx *ctx)
{
...
void *CMd5::md5_finish_ctx  (struct md5_ctx *ctx, void *resbuf)
{
...
void *CMd5::md5_read_ctx  (const struct md5_ctx *ctx, void *resbuf)
{
...
/* ------------------------------------------------------
        功能描述:   MD5摘要算法
--------------------------------------------------------- */
int CMd5::CreateMAC(unsigned char *UserInputPIN,unsigned char *EncryptedChar,unsigned int lngLen)
{
    ...
    md5_init_ctx (&ctx);
    md5_process_bytes (UserInputPIN, lngLen, &ctx);
...
功能描述:   MD5摘要算法
--------------------------------------------------------- */
int CMd5::MD5_MAC(unsigned char *UserInputPIN,unsigned char *EncryptedChar,unsigned int lngLen)
{
	unsigned char EnChar[16];
	struct md5_ctx ctx;
